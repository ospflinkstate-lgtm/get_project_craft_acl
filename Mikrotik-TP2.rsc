# 2026-05-20 16:03:59 by RouterOS 7.20.6
...
add action=accept chain=forward comment=\
    "[02-A] ALLOW ICMP (PING) FOR POC VERIFICATION" protocol=icmp
add action=accept chain=forward comment=\
    "[03] ALLOW PUBLIC WEB TRAFFIC TO WAF" dst-address-list=waf-frontend \
    dst-port=80,443 protocol=tcp
add action=accept chain=forward comment="[02-B] ALLOW WAF TO BACKEND APACHE" \
...
set winbox address=10.27.0.0/16,192.168.64.0/20
set api disabled=yes
set api-ssl disabled=yes
/system clock
set time-zone-name=Asia/Bangkok
/system identity
set name=MKT-Transparent-FW
/system ntp client
set enabled=yes
